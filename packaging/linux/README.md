...
- **.spec (OBS):** غلاف AppImage؛ عند التقديم على OBS أنشئ مشروعاً أضف فيه `_service` داخل الملفات لسحب `%{SOURCE0..2}`.
- **snapcraft.yaml:** بناء من المصدر مع webkit2gtk-4.1 — إن فشل البناء على Snapcraft اقلب إلى نفس نهج غلاف AppImage.
